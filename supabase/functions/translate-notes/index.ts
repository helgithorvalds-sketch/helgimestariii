    ...
    const response = await fetch("https://ai.gateway.lovable.dev/v1/chat/completions", {
      ...
      body: JSON.stringify({
        ...
        messages: [
          {
            role: "system",
            content: `Þú ert þýðandi. Þýddu textann yfir á íslensku. 
Haltu sömu merkingu og uppbyggingu en gerðu hana náttúrulega á íslensku.
Svaraðu AÐEINS með þýðingunni, ekkert annað.`,
          },
          {
            role: "user",
            content: notes,
    ...
    console.error("translate-notes error:", e);
    return new Response(
