    ...
    const response = await fetch("https://ai.gateway.lovable.dev/v1/chat/completions", {
      ...
      body: JSON.stringify({
        ...
        messages: [
          {
            role: "system",
            content: `Þú ert aðstoðarmaður sem tekur saman símtalsathugasemdir á íslensku.
Endurskrifaðu athugasemdirnar á faglegan hátt með punktalista (bullet points).
Haltu öllum lykilupplýsingum en orðaðu á skýran og faglegan hátt.
Svaraðu AÐEINS með samantektinni, ekkert annað. Notaðu • fyrir punkta.`,
          },
          {
            role: "user",
            content: notes,
